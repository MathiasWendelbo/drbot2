<%@ Page Title="" Language="C#" MasterPageFile="~/Cms.Master" AutoEventWireup="true" CodeBehind="sp.aspx.cs" Inherits="drbot1.sp" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="left">
        ...
        <div class="ned">
            <table>
                <tr><td>Spørgsmål</td><td>
                    <asp:TextBox ID="TextBox_sp" runat="server" ValidationGroup="form"></asp:TextBox>
                                      </td><td>
                                          <asp:RequiredFieldValidator ID="RequiredFieldValidator_sp" runat="server" ErrorMessage="Du skriv spørgsmål" ControlToValidate="TextBox_sp" ValidationGroup="form">*</asp:RequiredFieldValidator></td></tr>
                <tr><td>Svar</td><td>
                ...
                <tr><td><asp:Label ID="Label_opret" runat="server"></asp:Label></td><td><asp:Button ID="Button_opret" runat="server" Text="Opret" ValidationGroup="form" OnClick="Button_opret_Click" /></td></tr>
            </table>
        </div>
        <div class="ned">
        ...
        <div class="ned">
            <table>
                <tr><td>Valg</td><td>
                    <asp:DropDownList ID="DropDownList_valg" runat="server" AutoPostBack="true" OnSelectedIndexChanged="DropDownList_valg_SelectedIndexChanged"></asp:DropDownList>
